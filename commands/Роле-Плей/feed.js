...
module.exports.run = async (bot, message, args, data) => {
  ...
  const { body } = await global.superagent.get("https://nekos.life/api/v2/img/feed");
...
module.exports.help = {
  ...
  description: "Дать еду пользователю. (Стоимость 10 бананов.)",
  usages: { "feed @User#0001": "Покормить `@User#0001`" },
